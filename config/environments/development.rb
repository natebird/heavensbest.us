Heavensbest::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'heavensbest.dev' }
  ...
  Rails.application.config.middleware.use OmniAuth::Builder do
    ...
    provider :twitter, 'HYNfa0SCpOEo84TQ77PNg', 'YR97qAgg5YupIUNH6yL6pvGpypKr18E1F3iconwYCI'
